...
// kaBoom.setBackground(kaBoom.Color.fromHex("#966147"));

// kaBoom.scene("main", { level });

kaBoom.scene("main", Main);
kaBoom.scene("puzzle", Puzzle);
...
//             );
//           });
//         } else if (boundary.type === "newScene") {
//           player.onCollide(boundary.name, () => {
//             const passphrase = true;
//             if (passphrase) {
...
// scene("puzzle", (worldState) => setPuzzle(worldState));
